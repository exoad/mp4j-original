...
public class ColorContent {
  ...
  public static final Color VOLUME_SLIDER_HEARING_LOSS_FG = ColorTool
      .hexToRGBA(ResourceFolder.pm.get(ProjectManager.KEY_VOLUME_SLIDER_HEARING_LOSS_FG_HEX_COLOR));
  ...
  public static final Color VOLUME_SLIDER_WARNING_FG = ColorTool
      .hexToRGBA(ResourceFolder.pm.get(ProjectManager.KEY_VOLUME_SLIDER_WARNING_FG_HEX_COLOR));
  ...
  public static final Color VOLUME_SLIDER_MUTED_FG = ColorTool
      .hexToRGBA(ResourceFolder.pm.get(ProjectManager.KEY_VOLUME_SLIDER_MUTED_FG_HEX_COLOR));
