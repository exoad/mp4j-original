...
import old.backend.audio.Music;
  ...
  public String prettyMetaData() {
    ...
    if (!origF.getName().endsWith(".mp3")) {
      ...
      try {
        ...
        sb.append("<html><div style='text-align: center;'><p>");
        sb.append("<b><u>Track Name:</u></b> ").append(orig).append("<br>");
        sb.append("<b><u>Artist:</u></b> ")
            .append(tag.getFirst(org.jaudiotagger.tag.FieldKey.ALBUM_ARTIST).equals("")
                || tag.getFirst(org.jaudiotagger.tag.FieldKey.ALBUM_ARTIST) == null ? "Unknown"
                    : tag.getFirst(org.jaudiotagger.tag.FieldKey.ALBUM_ARTIST))
            .append("<br>");
        sb.append("<b><u>Album:</u></b> ")
            .append(tag.getFirst(org.jaudiotagger.tag.FieldKey.ALBUM).equals("")
                || tag.getFirst(org.jaudiotagger.tag.FieldKey.ALBUM) == null ? "Unknown"
                    : tag.getFirst(org.jaudiotagger.tag.FieldKey.ALBUM))
            .append("<br>");
        sb.append("<b><u>Genre:</u></b> ")
            .append(tag.getFirst(org.jaudiotagger.tag.FieldKey.GENRE).equals("")
                || tag.getFirst(org.jaudiotagger.tag.FieldKey.GENRE) == null ? "Unknown"
                    : tag.getFirst(org.jaudiotagger.tag.FieldKey.GENRE))
            .append("<br>");
        sb.append("<b><u>Year:</u></b> ")
            .append(tag.getFirst(org.jaudiotagger.tag.FieldKey.YEAR).equals("")
                || tag.getFirst(org.jaudiotagger.tag.FieldKey.YEAR) == null ? "Unknown"
